...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002415879692').split()]
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://bro:bro@mrz.o5yqa.mongodb.net/?retryWrites=true&w=majority&appName=mrz") # Necessary If clone mode is true
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', '-1002194601228') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.
